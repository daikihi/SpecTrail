...
- List all annotations in your project on both document and programming code.
...
- Search for annotations based on their metadata on both document and programming code.

# Reference

- [Input / output : io.md](./io.md)
- [usecases](./use_cases.md)
- [flow](./flow.md)
- [usage](./usage.md)