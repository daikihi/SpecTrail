...
> Canonical source: `specify_manual/meta.md` on the `main` branch — this file is a convenience copy kept in `specs/001-spec-impl-annotations/` for local viewing and reference. Edit the `specify_manual/meta.md` file in the `main` branch to make canonical changes. To update this copy, run the documented sync procedure (see `specs/001-spec-impl-annotations/README.md` or `scripts/sync-metamodel.sh`).
>
> NOTE: Do not edit this file directly unless performing a documented sync/update.
