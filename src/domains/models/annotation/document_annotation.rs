/// [@st-spec-annotation-structure-file] layer: abstract, type: File, name: document_annotation.rs
...
/// [@st-spec-annotation-structure] layer: abstract, type: Structure, name: DocumentAnnotation
