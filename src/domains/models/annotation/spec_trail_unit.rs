/// [@st-spec-annotation-structure-file] layer: abstract, type: File, name: spec_trail_unit.rs
...
/// [@st-spec-annotation-structure] layer: abstract, type: Structure, name: SpecTrailUnit
